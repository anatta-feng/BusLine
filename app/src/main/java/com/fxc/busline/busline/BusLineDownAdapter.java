...
public class BusLineDownAdapter extends RecyclerView.Adapter<BusLineDownAdapter.MyViewHolder> {

	private List<BusLinesBean.DownBean> mDataList;
	private Context mContext;

	public BusLineDownAdapter(List<BusLinesBean.DownBean> mDataList, Context mContext) {
